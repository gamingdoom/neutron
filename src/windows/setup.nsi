...
!define APPNAME "NEUTRON_APP_NAME"
!define PROGNAME "NEUTRON_INTERNAL_APP_NAME"
!define EXECUTABLE "launch-${PROGNAME}.exe"
!define PROG_VERSION "NEUTRON_APP_VERSION"
!define COMPANYNAME "NEUTRON_APP_NAME"
!define ESTIMATED_SIZE 190000
!define MUI_ICON "NEUTRON_INTERNAL_APP_NAME.ico"
...
!define MUI_WELCOMEPAGE_TITLE "Welcome to the NEUTRON_APP_NAME Setup"
!define MUI_WELCOMEPAGE_TEXT "This setup will guide you through the installation of NEUTRON_APP_NAME.$\r$\n$\r$\n\
...
Section
	...
	# Make sure app is closed before the installation
	...
	${If} $R0 = 0
		...
		MessageBox MB_OKCANCEL "NEUTRON_APP_NAME is still running and has to be closed for the setup to continue." IDOK continue IDCANCEL break
break:
		SetErrorlevel 1
		Abort
continue:
	...
	# Copy files
	SetOutPath $INSTDIR
	File /r NEUTRON_INTERNAL_APP_NAME\*.*
...
section "Uninstall"
	...
	# Kill app if it is still running
	nsProcess::_FindProcess "${EXECUTABLE}"
	Pop $R0
	${If} $R0 = 0
